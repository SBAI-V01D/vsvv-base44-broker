// ============================================================================
// avaSysAIByNik Premium Broker — Database Seed
...
async function main(): Promise<void> {
  console.log('🌱 avaSysAIByNik Database Seed — Starting...')
  console.log('')
  ...
  const org = await prisma.organization.upsert({
    where: { id: 'org-avasys-main' },
    update: {},
    create: {
      id: 'org-avasys-main',
      name: 'avaSysAIByNik Premium Broker AG',
      type: 'broker',
      status: 'active',
      ...
      email: 'info@avasys.ch',
      website: 'https://avasys.ch',
    },
  })
  ...
  const usersData: UserSeed[] = [
    { id: 'user-admin',        email: 'admin@avasys.ch',        name: 'Admin User',        role: 'admin' },
    { id: 'user-management',   email: 'management@avasys.ch',   name: 'Management User',   role: 'management' },
    { id: 'user-broker-1',     email: 'broker1@avasys.ch',      name: 'Hans Muster',       role: 'broker' },
    { id: 'user-broker-2',     email: 'broker2@avasys.ch',      name: 'Lisa Beispiel',     role: 'broker' },
    { id: 'user-backoffice',   email: 'backoffice@avasys.ch',   name: 'Backoffice User',   role: 'backoffice' },
    { id: 'user-finance',      email: 'finance@avasys.ch',      name: 'Finance User',      role: 'finance' },
    { id: 'user-support',      email: 'support@avasys.ch',      name: 'Support User',      role: 'support' },
    { id: 'user-compliance',   email: 'compliance@avasys.ch',   name: 'Compliance User',   role: 'compliance' },
  ]
