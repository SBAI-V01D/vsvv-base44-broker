// ============================================================================
// avaai Backend — Integration-Test Suite
// ============================================================================
...
async function main() {
  ...
  const adminToken = jwt.sign(
    { id: 'admin-test', email: 'admin@avaai.ch', role: 'admin', organization_id: 'org-test' },
    JWT_SECRET,
    { expiresIn: '5m' },
  );
  const userToken = jwt.sign(
    { id: 'user-test', email: 'user@avaai.ch', role: 'user', organization_id: 'org-test' },
    JWT_SECRET,
    { expiresIn: '5m' },
  );
