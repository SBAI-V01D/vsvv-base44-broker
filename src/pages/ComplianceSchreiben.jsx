...
export default function ComplianceSchreiben() {
  ...
  const handleEmail = () => {
    ...
    window.open(`mailto:support@avasys.com?subject=${subject}&body=${body}`);
  };
  ...
  return (
    <div className="max-w-5xl mx-auto p-6 space-y-6 page-enter">
      ...
      <Card className="border-l-4 border-l-primary">
        ...
        <CardContent className="space-y-3">
          <ol className="list-decimal list-inside space-y-2 text-sm">
            ...
            <li>Per E-Mail senden an: <strong>support@avasys.com</strong></li>
      ...
      <div className="flex items-center justify-center gap-2 text-muted-foreground text-sm">
        ...
        <a 
          href="https://avasys.com/security" 
          target="_blank" 
