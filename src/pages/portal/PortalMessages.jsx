...
export default function PortalMessages() {
  ...
  const { data: interactions = [] } = useQuery({
    ...
    queryFn: () => vsvv.entities.Interaction.filter({ customer_id: customerId, is_customer_request: true }, '-created_date'),
    enabled: !!customerId,
  });

  const { data: allMessages = [] } = useQuery({
    queryKey: ['portal-messages', customerId],
    queryFn: () => vsvv.entities.Message.filter({ customer_id: customerId }),
    enabled: !!customerId,
