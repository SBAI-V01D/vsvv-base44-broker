...
const BG_URL = 'https://media.avasys.com/images/public/69f07890d7d9106eb68a2c98/cebd2b2f0_VSVV2.png'
...
export default function PortalSetup() {
  ...
  const handleLogin = async (e) => {
    ...
    setLoading(true)
    try {
      const lookupResult = await avasys.functions.invoke('managePortalPassword', { action: 'lookup_customer', email })
      ...
      const verifyResult = await avasys.functions.invoke('managePortalPassword', { action: 'verify', customer_id, password })
  ...
  const handleChangePassword = async (e) => {
    ...
    try {
      ...
      const changeResult = await avasys.functions.invoke('managePortalPassword', { action: 'change_password', customer_id, old_password: password, new_password: newPassword })
      localStorage.setItem('portal_customer_id', customer_id)
      localStorage.setItem('portal_email', email)
    ...
    <div style={{
      ...
      <div className="login-column" style={{
        ...
        <div style={{
          ...
          <span>© 2025 avaSysAIByNik – Ihre Versicherungsplattform</span>
