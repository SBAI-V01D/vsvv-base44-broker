...
export default function SystemTestingDashboard() {
  ...
  const handlePhase1Test = async () => {
    ...
    try {
      const result = await avaai.functions.invoke('validateDashboardKPIs', {});
  ...
  const handlePhase2Test = async () => {
    ...
    try {
      const result = await avaai.functions.invoke('checkDataConsistency', {});
  ...
  const handlePhase3Test = async () => {
    ...
    try {
      const result = await avaai.functions.invoke('auditSecurityRules', {});
