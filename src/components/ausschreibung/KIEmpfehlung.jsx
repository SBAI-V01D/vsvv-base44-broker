  ...
  "handlungsempfehlung": "Konkrete nächste Schritte..."
      ...
      if (res.scores) {
        for (const o of offerten) {
          ...
          if (sc) {
            await avaai.entities.Offerte.update(o.id, {
